...
class _ZoomScaffoldState extends State<ZoomScaffold>
    ...
    return zoomAndSlideContent(new Container(
      child: new Scaffold(
            ...
            actions: <Widget>[
              Container(
                ...
                child: AppImageWidget(
                  imageUrl: AppAssets.shopping_bag,
                  height: 10,
                ),
              ),
              Container(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: [
            _bottomMenu(
              activeImage: AppAssets.home_active,
              image: AppAssets.home,
            ),
            _bottomMenu(
              activeImage: AppAssets.my_order_active,
              image: AppAssets.my_order,
            ),
            _bottomMenu(
              activeImage: AppAssets.notification_active,
              image: AppAssets.notification,
            ),
            _bottomMenu(
              activeImage: AppAssets.profile_active,
              image: AppAssets.profile,
            ),
            _bottomMenu(
              activeImage: AppAssets.searchActive,
  ...
  _bottomMenu({required String activeImage, required String image}) {
